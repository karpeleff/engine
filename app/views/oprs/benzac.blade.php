...
<div class="container">
    ...
    <div class="py-5 text-center">
        ...
        <h2>Журнал регистрации расхода бензина</h2>
        <p class="lead">Вводим дату запуска техники</p>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" method="post" action="/oprs/addbenz" novalidate>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="firstName">Дата запуска</label>
                        <input type="text" class="form-control" id="start" placeholder="" name="date" value="" required>
                ...
                <div class="row">
          <div class="col-md-6 mb-3">
            <label for="country">Выбрать технику</label>
            <select name="time" class="custom-select d-block w-100" id="country" required>
              <option value="1">косилка 1</option>
              <option value="2">косилка 2</option>
              <option value="3">снегоход</option>
            </select>
            <div class="invalid-feedback">
 ...
 <div class="col-md-6 mb-3">
            <label for="country">время работы</label>
            <select name="type" class="custom-select d-block w-100" id="country" required>
